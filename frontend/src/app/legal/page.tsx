                ...
                {activeTab === 'terms' ? (
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      CAREFULLY BEFORE USING THE SERVICES OFFERED BY OpenAgent (701 Tillery Street Unit 12-2521 Austin, Texas 78702,
                      United States). THIS AGREEMENT SETS FORTH THE LEGALLY
                      BINDING TERMS AND CONDITIONS FOR YOUR USE OF THE OpenAgent
                    ...
                    <ul className="text-muted-foreground space-y-1 mb-6">
                      <li>
                        "Company" refers to OpenAgent (701 Tillery Street
                        Unit 12-2521 Austin, Texas 78702, United States).
                      </li>
                      <li>
                        "Site" refers to the OpenAgent website, including any related
                        features, content, or applications offered from time to
                        time by the Company.
                      </li>
                      <li>
                        "Service" refers to the OpenAgent website and all related
                      ...
                      <li>
                        ...
                        Company, specifically legal@openagent.com
                      </li>
                      <li>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      OpenAgent is licensed under the Apache License, Version 2.0.
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      please write to legal@openagent.com and we will process and
                    ...
                    <p className="text-muted-foreground text-balance mb-4">
                      ...
                      or by emailing us at legal@openagent.com. If you cancel
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      All OpenAgent logos, marks, and designations are trademarks or
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      LIMITATION, THE OpenAgent WEB APP AND ANY CONTENT) IS PROVIDED
                      ...
                      OpenAgent DOES NOT GUARANTEE THE ACCURACY, COMPLETENESS, OR
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      ...
                      by emailing us at{' '}
                      <a
                        href="mailto:legal@openagent.com"
                        className="text-secondary hover:underline"
                      >
                        legal@openagent.com
                      </a>
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      References to our "Services" at OpenAgent in this statement
                    ...
                    <p className="text-muted-foreground text-balance mb-6">
                      OpenAgent does not collect biometric or identifying
