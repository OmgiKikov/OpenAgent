...
async def get_all_projects() -> List[Dict[str, Any]]:
    ...
    while has_more:
        ...
        result = (
            ...
            .select("project_id", "name", "account_id", "sandbox")
    ...
    projects_with_sandboxes = [
        project for project in all_projects if project.get("sandbox") and project["sandbox"].get("id")
    ]
...
async def main():
    ...
    try:
        ...
        inactive_projects = [
            project for project in all_projects if project.get("account_id") not in active_billing_customer_account_ids
        ]
