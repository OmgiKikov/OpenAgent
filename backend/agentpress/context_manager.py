...
class ContextManager:
    ...
    async def create_summary(
        self, thread_id: str, messages: List[Dict[str, Any]], model: str = "gpt-4o-mini"
...
"""
                ...
                summary_message = {"role": "user", "content": formatted_summary}
    ...
    async def check_and_summarize_if_needed(
        ...
        try:
            ...
            if force:
                ...
                logger.info(
                    f"Thread {thread_id} exceeds token threshold ({token_count} >= {self.token_threshold}), summarizing..."
                )
