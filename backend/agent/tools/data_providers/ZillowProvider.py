...
if __name__ == "__main__":
    ...
    property_result = tool.call_endpoint(route="propertyV2", payload={"zpid": "7594920"})
    ...
    zestimate_result = tool.call_endpoint(route="zestimate_history", payload={"zpid": "20476226"})
    ...
    similar_result = tool.call_endpoint(route="similar_properties", payload={"zpid": "28253016"})
