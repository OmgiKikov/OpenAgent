...
if __name__ == "__main__":
    ...
    tickers_result = tool.call_endpoint(route="get_tickers", payload={"page": 1, "type": "STOCKS"})
    ...
    news_result = tool.call_endpoint(route="get_news", payload={"tickers": "AAPL", "type": "ALL"})
    ...
    earnings_calendar_result = tool.call_endpoint(route="get_earnings_calendar", payload={"date": "2023-11-30"})
